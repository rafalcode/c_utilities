...
void prtusage()
{
    ...
    printf("Before filtering however, please run with -d (details) option is for showing is rough spread of the values,\n");
    printf("So you can choose a filtering value more easily.\n");
    return;
}
