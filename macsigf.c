...
void prtusage()
{
	...
	printf("and a number, specified by -f which the bedgraph file will be filtered for.\n");
	printf("The -d option is for showing details of the bedgraph file\n.");
	return;
}
